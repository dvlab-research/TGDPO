...
class RLHFArguments:
    ...
    tgdpo_alpha: float = field(
        default=0.5,
        metadata={"help": "The alpha parameter in the tgdpo loss."},
    )
    tgdpo_reward_model: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the reward model used for the TGDPO training."},
    )
